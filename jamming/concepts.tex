...
The second, \emph{ \nameref{ch:jamming:concepts:playful_blobs} }, seeks to draw on known interaction metaphors from the digital world and  expose them to
 physical objects.
...
The blobs are clay-like objects meant to be molded into creative forms.
...
More specifically each command means (see also figure~\ref{}:
\begin{itemize}
