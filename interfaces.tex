...
In \todo{section/chapter ref til afsnit} we will further discuss context awareness in relation to ad hoc interfaces. \todo{lidt mere afrunding}
...
\end{quote}
Adding to the suggestion that the boundaries between computers and people will disappear.
...
\citeauthor{abowd2012next} focuses on the more software-related aspects of a future-to-come and properly a more ``approximate-future'' than \citeauthor{ishii2012radical} material based adaptability. 
\blank
In this thesis we try to give a contribution to one of the directions that future computing can take, a direction that is ubiquitous in spirit but focus on new materials and interaction possibilities, and new relationships between computers and humans.

\todo{afrunding med fokus paa AHI, evt note til domain}