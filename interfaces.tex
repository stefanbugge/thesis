...
\cite{rasmussen2012shape} presents a is in line with what , though with texture standing out as a case for itself possibly for the same reason as we noted earlier.  
...
\hl{Our own exploratory work will focus only on topological transformations, excluding spatiality, since our choice of technology hinders this type of change.} This will be further described in section \ref{ch:jamming/jamming}.     
