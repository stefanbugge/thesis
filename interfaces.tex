...
The use of metaphors as described in level 3 does also somewhat fit into the this level since the GUI is adapting physical attributes (the office) into the virtual space and in that way incorporates the surrounding environment, though in a static way.
The fourth level (1980s-1990s) focus on the interface as an interaction dialogue where the interface can be adapted and tailored, by the computer, to the specific user.
...
This notion is strongly supported a year later with Mark Weiser's vision of ubiquitous computing.
...
In this section we will take a look at how ubiquitous computing, and many of the paradigms following it, has changed the relationship between the physical world and digital world.

\todo{more to come!}

\subsection{Computer generations}
\todo{maybe use abowds generations to introduce ubicomp}
