...
\begin{figure}[h]
  \centering
  \includegraphics[width=.9\textwidth]{figures/proto3/light-variable-res.jpg}
  \caption{Four frames from a video (appendix~\ref{app:videos:cpaint}) where a custom dimmer (variable resistor) is created on the spot, then used to dim the lights, and lastly the dimmer is removed again from the surface of the wall.}
