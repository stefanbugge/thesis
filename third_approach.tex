...
We still \todo{stuff here needs fixing} that the idea of creating the actual material interface on the spot, where the interface is fashioned to your current needs and shaped to your liking, is wildly enticing, though it might not be entirely realistic.
