...
In figure \ref{fig:ch:proto3:wallpaint} a room is shown with its wiring exposed to the inhabitants as a mix of functionality and wall art that can be remade or adapted as they see fit.
Please refer to the videos that these frames where taken from, see appendix~\ref{app:videos:cpaint}.
