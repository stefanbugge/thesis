...
We see this as an important point because if the interface is not inherently relevant in its background state, in the sense of having a ``natural'' or ``passive'' function
...
Along with this definition we new suggest four approaches to the creation of such interfaces,
