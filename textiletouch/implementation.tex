...
The prototype was made in linen which is robust but a lot finer and thinner that the sofa textile and the conductive thread sewed with less close seams.
The prototype can be seen in figure~\todo{ref} and the schematics for the hardware setup can be seen in appendix \ref{app:textile-touch}.

 where limited by the baud-rate\footnote{http://en.wikipedia.org/wiki/Baud} 
