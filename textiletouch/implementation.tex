...
The ability to propagate vibration is also constrained by the choice of materials, and the linen (textile) we have used does not excel in this.
...
As our micro controller is already running at over capacity this out of the question for now, but by replacing the micro controller with a more powerful one, as mentioned before, increasing the resolution could become relevant again.
