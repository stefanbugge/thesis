...
So for a j x i grid, the amount of pin needed would be in the range of \(\sqrt{j*i}\), compared to the \(i*j\) from iteration 1, reducing the complexity by the square root.
