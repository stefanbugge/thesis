...
\hl{We were interested in shedding light on the diversity of creative ideas a child would bring compared to an adult.
}
\todo{mere + afrunding}
\blank
...
During the evaluation we would connect the prototype setup and computer to the home TV to resemble the real situation and the prototype would for instance be laid as part of the sofa, as a table cloth or attached to a wall as for example wallpaper.
...
\begin{figure}
        ...
        \end{subfigure}
        \caption{Teenager during evaluation \dots \todo{ret tekst}}
...
% handicap
Some disabled people with hindered mobility \todo{mere eller slet}
\blank
% Home security
...
\subsection{Future work for Textile Touch}
