...
From there on the basics of interaction were understood and further discussions and explorations could be made.
...
\subsubsection{The concept as a controller for existing devices}

\subsubsection{Potentials of alternative usages}
