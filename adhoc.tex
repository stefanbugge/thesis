...
We can't just magically make physical objects appear and disappear which is easy to do on a digital display.
...
\subsubsection{Relationship with other fields} 
% CAC comparison
...
\blank
% TUI comparison
Tangible user interfaces, or TUIs, do generally not exhibit ad hoc characteristics. \todo{det skal lige overvejes om det er helt sandt}
They are mentioned here more for their movement away from the standard GUI paradigm for human-computer interaction.
TUIs demonstrate a inherently tight coupling between digital information and the associated physical object, for example tangible tokens representing a specific digital entity or mapping to a specific function or action.
