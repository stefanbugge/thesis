...
This will be exemplified in \autoref{ch:textile-touch} where we prototype a general purpose ad hoc interface called Textile Touch, which can augment existing household objects by adding a digital layer. \todo{ovevej lige hvordan det bliver augmented}
\blank
...
Last but not least, we have identified three approaches to approaching AHIs that will be the guidelines for further explorations throughout this thesis.
...
\section{Past work and research through design}
...
Both are addressing the approach we earlier labeled 

\begin{quotation}
	\emph{Through invisible interfaces embedded into the physical environment}. \todo{yes, Tore?}
\end{quotation}
