...
In this thesis we will introduce the notion of \emph{Ad Hoc Interfaces} or AHIs. \todo{based on \dots and \dots}
...
\todo{summarise directions from previous chapters \dots}
...
If the display is off the physical object's core function is mirroring, but when turned on the physical object is a display container.
...
The project that we would like to review was made during a masters course in 2011 called Innovation Project\footnote{https://services.brics.dk/java/courseadmin/Inno\_pro2011}.
...
Firstly, the acoustic features are hidden when not needed and then highly \todo{prevalent} when active as the otherwise static nature of walls start going in motion providing an engaging aesthetic expression.
...
\section{Relationship with other fields} 
...
\todo{Next we will give our own definition of being ad hoc when applied to the field of physical user interfaces and also compare this to other parts of the HCI research area.}
